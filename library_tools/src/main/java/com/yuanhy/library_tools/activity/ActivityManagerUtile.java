...
public class ActivityManagerUtile {
    private static ActivityManagerUtile instance = new ActivityManagerUtile();
    private static HashSet<Activity> hashSet = new HashSet<>();

    private ActivityManagerUtile() {

    }

    public static ActivityManagerUtile getInstance() {
        return instance;
    }
