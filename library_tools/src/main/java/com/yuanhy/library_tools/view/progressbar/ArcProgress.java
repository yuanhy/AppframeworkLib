package com.yuanhy.library_tools.view.progressbar;
...
public class ArcProgress extends ProgressBar {
    ...
    private final int DEFAULT_LINEHEIGHT = dp2px(6);//进度的宽度
    private final int DEFAULT_mTickWidth = dp2px(2);
    private final int DEFAULT_mRadius = dp2px(60);//圆半径
    private final int DEFAULT_mUnmProgressColor = Color.parseColor("#d4dfea");
    private final int DEFAULT_mProgressColor = Color.parseColor("#869fba"); ;
