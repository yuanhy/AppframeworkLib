            ...
            public void run() {
                try {
                    if (mCryptoObject != null) {
                        ...
                        // of the fingerprint.
                        if (!initCipher()) {
                                    AppFramentUtil.logCatUtil.v("Failed to init Cipher.");
                        }
                    }
                } catch (Exception e) {
                            AppFramentUtil.logCatUtil.v(" Failed to init Cipher, e:" + Log.getStackTraceString(e));
                }
        ...
        try {
            ...
            mKeyGenerator.generateKey();
                ...
                | CertificateException | IOException e) {
                    AppFramentUtil.logCatUtil.v(" Failed to createKey, e:" + Log.getStackTraceString(e));
    ...
    private boolean initCipher() {
        try {
            ...
            return true;
                    ...
                    AppFramentUtil.logCatUtil.v(" Failed to initCipher, e:" + Log.getStackTraceString(e));
            return false;
